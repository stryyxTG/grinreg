...
- Генерация iPhone JSON-профиля для зарегистрированного аккаунта.
...
4. После успешного входа аккаунт попадает в `Хранилище`.
5. В карточке аккаунта можно проверить session, скопировать номер, скачать файлы или удалить аккаунт.
